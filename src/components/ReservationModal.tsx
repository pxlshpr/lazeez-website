...
import { X, Phone, MessageCircle, Users, Calendar, Clock, Armchair } from "lucide-react";
...
export function ReservationModal({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-white dark:bg-neutral-900 w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl max-h-[90vh] sm:max-h-[85vh] flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-cream-dark dark:border-neutral-700 shrink-0">
        ...
        <div className="overflow-y-auto flex-1">
          {step === "choose" ? (
            <div className="p-5 space-y-3">
              ...
              <button
                onClick={handleClose}
                className="w-full text-charcoal-light dark:text-neutral-500 text-sm py-3 hover:text-charcoal dark:hover:text-white transition-colors"
              >
                Cancel
              </button>
            </div>
